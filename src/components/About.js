    ...
    <section id='about' className='section' ref={ref}>
      <div className='container mx-auto mt-5'>
        <div className='flex flex-col gap-y-12 lg:mt-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-2 h-screen'>
          {/* image */}
          <motion.div variants={fadeIn('right',0.3)} initial='hidden' whileInView={'show'} viewport={{once:false, amount:0.3}} className='flex-1 bg-about bg-contain bg-no-repeat h-[650px] mix-blend-lighten bg-top'></motion.div>
          {/* text */}
